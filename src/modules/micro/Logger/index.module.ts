...
import { RabbitMQController } from './index.controller'
...
@Module({
  ...
  imports: [
    ClientsModule.register([
      {
        ...
        options: {
          urls: [
            'amqp://MjpyYWJiaXRtcS1zZXJ2ZXJsZXNzLWNuLWxiajN0Zmw1MTA0OkxUQUk1dEJxajYxeW9oY2V0c0ZjeTZKcg==:RjgzODUzMTMyQjVGMjI2RkZGODBBMEEyREQ1NTUzRjU3QUEyOEU2NjoxNzIwMzQyMjk2ODk4@rabbitmq-serverless-cn-lbj3tfl5104.cn-beijing.amqp-22.net.mq.amqp.aliyuncs.com:5672',
          ],
          queue: 'logger_queue',
          queueOptions: {
            durable: true,
    ...
    //       ],
    //       // 连接的url
    //       uri: 'amqp://MjpyYWJiaXRtcS1zZXJ2ZXJsZXNzLWNuLWxiajN0Zmw1MTA0OkxUQUk1dEJxajYxeW9oY2V0c0ZjeTZKcg==:RjgzODUzMTMyQjVGMjI2RkZGODBBMEEyREQ1NTUzRjU3QUEyOEU2NjoxNzIwMzQyMjk2ODk4@rabbitmq-serverless-cn-lbj3tfl5104.cn-beijing.amqp-22.net.mq.amqp.aliyuncs.com',
    //       /**
